...
> 🔄 **2026.4+ 补充说明**：本章正文仍以网页归档、GitHub整理、论文笔记为主，但最新版 OpenClaw 的“知识库”主线已经升级为三层：**Active Memory（回复前回忆）**、**Dreaming（短期转长期）**、**Memory Wiki（结构化 claim/evidence + 矛盾/新鲜度管理）**。如果你正在搭建“第二大脑”，建议把本章与官方记忆文档一起阅读。
